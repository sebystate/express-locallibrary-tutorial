...
exports.bookinstance_list = function(req, res, next) {
    ...
    BookInstance.find()
      .populate('book') // this will replace the book id for each BookInstance with a full Book document
      .exec(function (err, result_list) {
        if (err) { return next(err); }
        // Successful, so render
        res.render('bookinstance_list', { title: 'Book Instance List', bookinstance_list: result_list });
      });
};
...
exports.bookinstance_delete_post = function(req, res, next) {
    ...
    .exec(function deleteBookInstance(err) {
        if (err) { return next(err); }
